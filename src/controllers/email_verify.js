...
export const requestMobileOtp = async (req, res) => {
  try {
    ...
    const response = await verifyemail.requestMobileOtp(access_token, X_token, loginId);
...
export const verifyMobileOtp = async (req, res) => {
  try {
    ...
    const response = await verifyemail.verifyMobileOtp({accessToken, X_token, txnId, otp });
